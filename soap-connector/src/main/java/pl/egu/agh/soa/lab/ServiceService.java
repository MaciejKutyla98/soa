 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://lab.soa.agh.edu.pl/", wsdlLocation = "http://localhost:8080/soa/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://lab.soa.agh.edu.pl/", "ServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soa/Service?wsdl");
    ...
    public pl.egu.agh.soa.lab.Service getServicePort() {
        return super.getPort(new QName("http://lab.soa.agh.edu.pl/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public pl.egu.agh.soa.lab.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab.soa.agh.edu.pl/", "ServicePort"), Service.class, features);
    }
